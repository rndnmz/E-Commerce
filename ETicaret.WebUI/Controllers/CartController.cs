...
namespace ETicaret.WebUI.Controllers
{
    public class CartController : Controller
    {
        ...
        [HttpPost]
        public IActionResult DeleteFromCart(int productId, int quantity)
        {
            var userId = _userManager.GetUserId(User);
        ...
        private Payment PaymentProcess(OrderModel model)
        {
            ...
            options.ApiKey = "sandbox-UBmtdjv7tsj5fI6aJ5FNmkHe1ENY6cwH";
            options.SecretKey = "sandbox-k45Iu8mypnYAc5cJA776syHBrkiPHoiK";
            ...
            shippingAddress.City = model.Address;
        ...
        {
            // Sepete ekledğimiz ürünleri, ödeme işlemi tamamlandıktan sonra Cart/CartItemms içindeki bilgiler Orders/OrderItems tablosuna taşınmalıdır.
            ...
            order.OrderNumber = new Random().Next(100000000, 999999999).ToString();
