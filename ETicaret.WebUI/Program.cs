...
builder.Services.AddDbContext<ApplicationContext>(option => option.UseSqlServer("Server=EREN\\SQLEXPRESS;Database=ETicaret;Integrated Security=true"));
...
new EmailSender("smtp.office365.com", 587, true, "rndnmz@hotmail.com", "Indepen1")
);
...
// Cart / Sepetim Ýþlemleri

app.MapControllerRoute(
    name: "cart",
    pattern: "/cart/deletefromcart",
    defaults: new { controller = "Cart", action = "DeleteFromCart" }
    );
